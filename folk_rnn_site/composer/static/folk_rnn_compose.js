...
/* globals rnnModels, rnnParseABC, rnnInvalidTokens, channels*/

let fieldModel = document.getElementById("id_model");
let fieldKey = document.getElementById("id_key");
let fieldMeter = document.getElementById("id_meter");
let fieldTokens = document.getElementById("id_prime_tokens");
...
fieldTokens.addEventListener("change", function() {
    "use strict";
    this.value = rnnParseABC(this.value).tokens.join(' ');
