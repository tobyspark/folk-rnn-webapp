...
urlpatterns = [
    ...
    url(r'^member/(?P<user_id>[0-9]+)/tunebook$', views.tunebook_page, name='tunebook'),
    url(r'^member/(?P<user_id>[0-9]+)/tunebook/download$', views.tunebook_download, name='tunebook_download'),
